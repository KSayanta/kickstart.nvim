...
vim.o.smartcase = true -- Case-sensitive if expression contains a capital letter

vim.o.backspace = 'start,eol,indent' -- Configure backspace so it acts as it should act
...
--  See `:help hlsearch`
vim.keymap.set('n', '<leader>nh', '<cmd>nohlsearch<CR>', { desc = 'No Hlsearch' })
...
require('lazy').setup({
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      -- For more details, see :h MiniAi.config
